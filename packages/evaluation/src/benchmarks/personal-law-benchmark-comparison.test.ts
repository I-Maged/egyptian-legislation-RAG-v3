// npm run personal-affairs-law-benchmark-comparison --workspace @egyptian-law/evaluation
...
describe.skipIf(!RUN_REAL_BENCHMARK)(
  ...
  () => {
    it("evaluates BM25, vector, and hybrid retrieval on the real corpus", async () => {
      ...
      console.log("Personal Affairs LAW RETRIEVAL DIAGNOSTICS");
      ...
      console.table([
        {
          ...
          queriesMissed: 70 - countHits("bm25"),
        },
        {
          system: "vector",
          queriesWithRelevantTop10: countHits("vector"),
          queriesMissed: 70 - countHits("vector"),
        },
        {
          system: "hybrid",
          queriesWithRelevantTop10: countHits("hybrid"),
          queriesMissed: 70 - countHits("hybrid"),
        },
      ]);
    }, 120_000);
  },
